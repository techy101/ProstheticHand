...
L_end___DSB:
BX	LR
; end of stm32f4xx_iwdg___DSB
stm32f4xx_iwdg___WFI:
...
L_end___WFI:
BX	LR
; end of stm32f4xx_iwdg___WFI
stm32f4xx_iwdg___WFE:
...
L_end___WFE:
BX	LR
; end of stm32f4xx_iwdg___WFE
stm32f4xx_iwdg___REV:
...
L_end___REV:
BX	LR
; end of stm32f4xx_iwdg___REV
stm32f4xx_iwdg_NVIC_SetPriorityGrouping:
...
BX	LR
; end of stm32f4xx_iwdg_NVIC_SetPriorityGrouping
stm32f4xx_iwdg_NVIC_GetPriorityGrouping:
...
BX	LR
; end of stm32f4xx_iwdg_NVIC_GetPriorityGrouping
stm32f4xx_iwdg_NVIC_EnableIRQ:
...
BX	LR
; end of stm32f4xx_iwdg_NVIC_EnableIRQ
stm32f4xx_iwdg_NVIC_DisableIRQ:
...
BX	LR
; end of stm32f4xx_iwdg_NVIC_DisableIRQ
stm32f4xx_iwdg_NVIC_GetPendingIRQ:
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f4xx_iwdg_NVIC_GetPendingIRQ0
; ?FLOC__stm32f4xx_iwdg_NVIC_GetPendingIRQ?T47 start address is: 0 (R0)
MOVS	R0, #1
; ?FLOC__stm32f4xx_iwdg_NVIC_GetPendingIRQ?T47 end address is: 0 (R0)
IT	AL
BAL	L_stm32f4xx_iwdg_NVIC_GetPendingIRQ1
L_stm32f4xx_iwdg_NVIC_GetPendingIRQ0:
; ?FLOC__stm32f4xx_iwdg_NVIC_GetPendingIRQ?T47 start address is: 0 (R0)
MOV	R0, #0
; ?FLOC__stm32f4xx_iwdg_NVIC_GetPendingIRQ?T47 end address is: 0 (R0)
L_stm32f4xx_iwdg_NVIC_GetPendingIRQ1:
; ?FLOC__stm32f4xx_iwdg_NVIC_GetPendingIRQ?T47 start address is: 0 (R0)
MOV	R0, R0
; ?FLOC__stm32f4xx_iwdg_NVIC_GetPendingIRQ?T47 end address is: 0 (R0)
;core_cm4.h,1112 :: 		}
...
BX	LR
; end of stm32f4xx_iwdg_NVIC_GetPendingIRQ
stm32f4xx_iwdg_NVIC_SetPendingIRQ:
...
BX	LR
; end of stm32f4xx_iwdg_NVIC_SetPendingIRQ
stm32f4xx_iwdg_NVIC_ClearPendingIRQ:
...
BX	LR
; end of stm32f4xx_iwdg_NVIC_ClearPendingIRQ
stm32f4xx_iwdg_NVIC_GetActive:
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f4xx_iwdg_NVIC_GetActive2
; ?FLOC__stm32f4xx_iwdg_NVIC_GetActive?T78 start address is: 0 (R0)
MOVS	R0, #1
; ?FLOC__stm32f4xx_iwdg_NVIC_GetActive?T78 end address is: 0 (R0)
IT	AL
BAL	L_stm32f4xx_iwdg_NVIC_GetActive3
L_stm32f4xx_iwdg_NVIC_GetActive2:
; ?FLOC__stm32f4xx_iwdg_NVIC_GetActive?T78 start address is: 0 (R0)
MOV	R0, #0
; ?FLOC__stm32f4xx_iwdg_NVIC_GetActive?T78 end address is: 0 (R0)
L_stm32f4xx_iwdg_NVIC_GetActive3:
; ?FLOC__stm32f4xx_iwdg_NVIC_GetActive?T78 start address is: 0 (R0)
MOV	R0, R0
; ?FLOC__stm32f4xx_iwdg_NVIC_GetActive?T78 end address is: 0 (R0)
;core_cm4.h,1151 :: 		}
...
BX	LR
; end of stm32f4xx_iwdg_NVIC_GetActive
stm32f4xx_iwdg_NVIC_SetPriority:
...
CMP	R0, #0
IT	GE
BGE	L_stm32f4xx_iwdg_NVIC_SetPriority4
...
STRB	R2, [R3, #0]
IT	AL
BAL	L_stm32f4xx_iwdg_NVIC_SetPriority5
L_stm32f4xx_iwdg_NVIC_SetPriority4:
...
AND	R2, R2, #255
STRB	R2, [R3, #0]
L_stm32f4xx_iwdg_NVIC_SetPriority5:
;core_cm4.h,1171 :: 		}
L_end_NVIC_SetPriority:
BX	LR
; end of stm32f4xx_iwdg_NVIC_SetPriority
stm32f4xx_iwdg_NVIC_GetPriority:
...
CMP	R0, #0
IT	GE
BGE	L_stm32f4xx_iwdg_NVIC_GetPriority6
...
L_stm32f4xx_iwdg_NVIC_GetPriority6:
...
BX	LR
; end of stm32f4xx_iwdg_NVIC_GetPriority
stm32f4xx_iwdg_NVIC_EncodePriority:
...
CMP	R3, #4
IT	LS
BLS	L_stm32f4xx_iwdg_NVIC_EncodePriority8
; ?FLOC__stm32f4xx_iwdg_NVIC_EncodePriority?T118 start address is: 12 (R3)
MOV	R3, #4
; ?FLOC__stm32f4xx_iwdg_NVIC_EncodePriority?T118 end address is: 12 (R3)
IT	AL
BAL	L_stm32f4xx_iwdg_NVIC_EncodePriority9
L_stm32f4xx_iwdg_NVIC_EncodePriority8:
RSB	R3, R4, #7
; ?FLOC__stm32f4xx_iwdg_NVIC_EncodePriority?T118 start address is: 0 (R0)
MOV	R0, R3
; ?FLOC__stm32f4xx_iwdg_NVIC_EncodePriority?T118 end address is: 0 (R0)
MOV	R3, R0
L_stm32f4xx_iwdg_NVIC_EncodePriority9:
; ?FLOC__stm32f4xx_iwdg_NVIC_EncodePriority?T118 start address is: 12 (R3)
...
CMP	R3, #7
IT	CS
BCS	L_stm32f4xx_iwdg_NVIC_EncodePriority10
; PriorityGroupTmp end address is: 16 (R4)
; ?FLOC__stm32f4xx_iwdg_NVIC_EncodePriority?T122 start address is: 20 (R5)
MOV	R5, #0
; ?FLOC__stm32f4xx_iwdg_NVIC_EncodePriority?T122 end address is: 20 (R5)
IT	AL
BAL	L_stm32f4xx_iwdg_NVIC_EncodePriority11
L_stm32f4xx_iwdg_NVIC_EncodePriority10:
; PriorityGroupTmp start address is: 16 (R4)
SUBS	R5, R4, #7
; PriorityGroupTmp end address is: 16 (R4)
ADDS	R5, R5, #4
; ?FLOC__stm32f4xx_iwdg_NVIC_EncodePriority?T122 start address is: 20 (R5)
; ?FLOC__stm32f4xx_iwdg_NVIC_EncodePriority?T122 end address is: 20 (R5)
L_stm32f4xx_iwdg_NVIC_EncodePriority11:
...
BX	LR
; end of stm32f4xx_iwdg_NVIC_EncodePriority
stm32f4xx_iwdg_NVIC_DecodePriority:
...
CMP	R4, #4
IT	LS
BLS	L_stm32f4xx_iwdg_NVIC_DecodePriority12
; ?FLOC__stm32f4xx_iwdg_NVIC_DecodePriority?T136 start address is: 16 (R4)
MOV	R4, #4
; ?FLOC__stm32f4xx_iwdg_NVIC_DecodePriority?T136 end address is: 16 (R4)
IT	AL
BAL	L_stm32f4xx_iwdg_NVIC_DecodePriority13
L_stm32f4xx_iwdg_NVIC_DecodePriority12:
RSB	R4, R5, #7
; ?FLOC__stm32f4xx_iwdg_NVIC_DecodePriority?T136 start address is: 4 (R1)
MOV	R1, R4
; ?FLOC__stm32f4xx_iwdg_NVIC_DecodePriority?T136 end address is: 4 (R1)
MOV	R4, R1
L_stm32f4xx_iwdg_NVIC_DecodePriority13:
; ?FLOC__stm32f4xx_iwdg_NVIC_DecodePriority?T136 start address is: 16 (R4)
...
CMP	R4, #7
IT	CS
BCS	L_stm32f4xx_iwdg_NVIC_DecodePriority14
; PriorityGroupTmp end address is: 20 (R5)
; ?FLOC__stm32f4xx_iwdg_NVIC_DecodePriority?T140 start address is: 16 (R4)
MOV	R4, #0
; ?FLOC__stm32f4xx_iwdg_NVIC_DecodePriority?T140 end address is: 16 (R4)
IT	AL
BAL	L_stm32f4xx_iwdg_NVIC_DecodePriority15
L_stm32f4xx_iwdg_NVIC_DecodePriority14:
; PriorityGroupTmp start address is: 20 (R5)
SUBS	R4, R5, #7
; PriorityGroupTmp end address is: 20 (R5)
ADDS	R4, R4, #4
; ?FLOC__stm32f4xx_iwdg_NVIC_DecodePriority?T140 start address is: 20 (R5)
MOV	R5, R4
; ?FLOC__stm32f4xx_iwdg_NVIC_DecodePriority?T140 end address is: 20 (R5)
MOV	R4, R5
L_stm32f4xx_iwdg_NVIC_DecodePriority15:
; ?FLOC__stm32f4xx_iwdg_NVIC_DecodePriority?T140 start address is: 16 (R4)
...
L_stm32f4xx_iwdg_NVIC_SystemReset16:
IT	AL
BAL	L_stm32f4xx_iwdg_NVIC_SystemReset16
;core_cm4.h,1267 :: 		}
L_end_NVIC_SystemReset:
LDR	LR, [SP, #0]
ADD	SP, SP, #4
BX	LR
; end of stm32f4xx_iwdg_NVIC_SystemReset
stm32f4xx_iwdg_SysTick_Config:
...
CMP	R0, R1
IT	LS
BLS	L_stm32f4xx_iwdg_SysTick_Config18
; ticks end address is: 0 (R0)
MOVS	R0, #1
IT	AL
BAL	L_end_SysTick_Config
L_stm32f4xx_iwdg_SysTick_Config18:
...
MOVS	R0, #-1
SXTB	R0, R0
BL	stm32f4xx_iwdg_NVIC_SetPriority+0
...
ADD	SP, SP, #4
BX	LR
; end of stm32f4xx_iwdg_SysTick_Config
stm32f4xx_iwdg_ITM_SendChar:
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f4xx_iwdg_ITM_SendChar33
MOVW	R1, #3712
MOVT	R1, #57344
LDR	R1, [R1, #0]
AND	R1, R1, #1
CMP	R1, #0
IT	EQ
BEQ	L_stm32f4xx_iwdg_ITM_SendChar34
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f4xx_iwdg_ITM_SendChar35
L_stm32f4xx_iwdg_ITM_SendChar29:
;core_cm4.h,1334 :: 		while (ITM->PORT[0].u32 == 0);
L_stm32f4xx_iwdg_ITM_SendChar22:
; ch end address is: 0 (R0)
; ch start address is: 0 (R0)
MOVW	R1, #0
MOVT	R1, #57344
...
CMP	R1, #0
IT	NE
BNE	L_stm32f4xx_iwdg_ITM_SendChar23
IT	AL
BAL	L_stm32f4xx_iwdg_ITM_SendChar22
L_stm32f4xx_iwdg_ITM_SendChar23:
...
;core_cm4.h,1331 :: 		(ITM->TCR & ITM_TCR_ITMENA_Msk)                  &&      /* ITM enabled */
IT	AL
BAL	L_stm32f4xx_iwdg_ITM_SendChar32
L_stm32f4xx_iwdg_ITM_SendChar33:
L_stm32f4xx_iwdg_ITM_SendChar32:
; ch start address is: 0 (R0)
; ch end address is: 0 (R0)
IT	AL
BAL	L_stm32f4xx_iwdg_ITM_SendChar31
L_stm32f4xx_iwdg_ITM_SendChar34:
L_stm32f4xx_iwdg_ITM_SendChar31:
;core_cm4.h,1332 :: 		(ITM->TER & (1UL << 0)        )                    )     /* ITM Port #0 enabled */
; ch start address is: 0 (R0)
; ch end address is: 0 (R0)
IT	AL
BAL	L_stm32f4xx_iwdg_ITM_SendChar30
L_stm32f4xx_iwdg_ITM_SendChar35:
L_stm32f4xx_iwdg_ITM_SendChar30:
...
L_end_ITM_SendChar:
BX	LR
; end of stm32f4xx_iwdg_ITM_SendChar
stm32f4xx_iwdg_ITM_ReceiveChar:
...
CMP	R1, R0
IT	EQ
BEQ	L_stm32f4xx_iwdg_ITM_ReceiveChar24
...
STR	R1, [R0, #0]
;core_cm4.h,1356 :: 		}
L_stm32f4xx_iwdg_ITM_ReceiveChar24:
...
ADD	SP, SP, #4
BX	LR
; end of stm32f4xx_iwdg_ITM_ReceiveChar
stm32f4xx_iwdg_ITM_CheckChar:
...
CMP	R1, R0
IT	NE
BNE	L_stm32f4xx_iwdg_ITM_CheckChar25
;core_cm4.h,1373 :: 		return (0);                                 /* no character available */
MOV	R0, #0
IT	AL
BAL	L_end_ITM_CheckChar
;core_cm4.h,1374 :: 		} else {
L_stm32f4xx_iwdg_ITM_CheckChar25:
;core_cm4.h,1375 :: 		return (1);                                 /*    character available */
MOVS	R0, #1
;core_cm4.h,1377 :: 		}
L_end_ITM_CheckChar:
BX	LR
; end of stm32f4xx_iwdg_ITM_CheckChar
_IWDG_WriteAccessCmd:
;stm32f4xx_iwdg.c,135 :: 		void IWDG_WriteAccessCmd(uint16_t IWDG_WriteAccess)
; IWDG_WriteAccess start address is: 0 (R0)
; IWDG_WriteAccess end address is: 0 (R0)
; IWDG_WriteAccess start address is: 0 (R0)
;stm32f4xx_iwdg.c,139 :: 		IWDG->KR = IWDG_WriteAccess;
MOVW	R1, #12288
MOVT	R1, #16384
STR	R0, [R1, #0]
; IWDG_WriteAccess end address is: 0 (R0)
;stm32f4xx_iwdg.c,140 :: 		}
L_end_IWDG_WriteAccessCmd:
BX	LR
; end of _IWDG_WriteAccessCmd
_IWDG_SetPrescaler:
;stm32f4xx_iwdg.c,155 :: 		void IWDG_SetPrescaler(uint8_t IWDG_Prescaler)
; IWDG_Prescaler start address is: 0 (R0)
; IWDG_Prescaler end address is: 0 (R0)
; IWDG_Prescaler start address is: 0 (R0)
;stm32f4xx_iwdg.c,159 :: 		IWDG->PR = IWDG_Prescaler;
MOVW	R1, #12292
MOVT	R1, #16384
STR	R0, [R1, #0]
; IWDG_Prescaler end address is: 0 (R0)
;stm32f4xx_iwdg.c,160 :: 		}
L_end_IWDG_SetPrescaler:
BX	LR
; end of _IWDG_SetPrescaler
_IWDG_SetReload:
;stm32f4xx_iwdg.c,168 :: 		void IWDG_SetReload(uint16_t Reload)
; Reload start address is: 0 (R0)
; Reload end address is: 0 (R0)
; Reload start address is: 0 (R0)
;stm32f4xx_iwdg.c,172 :: 		IWDG->RLR = Reload;
MOVW	R1, #12296
MOVT	R1, #16384
STR	R0, [R1, #0]
; Reload end address is: 0 (R0)
;stm32f4xx_iwdg.c,173 :: 		}
L_end_IWDG_SetReload:
BX	LR
; end of _IWDG_SetReload
_IWDG_ReloadCounter:
;stm32f4xx_iwdg.c,181 :: 		void IWDG_ReloadCounter(void)
;stm32f4xx_iwdg.c,183 :: 		IWDG->KR = KR_KEY_RELOAD;
MOVW	R1, #43690
MOVW	R0, #12288
MOVT	R0, #16384
STR	R1, [R0, #0]
;stm32f4xx_iwdg.c,184 :: 		}
L_end_IWDG_ReloadCounter:
BX	LR
; end of _IWDG_ReloadCounter
_IWDG_Enable:
;stm32f4xx_iwdg.c,207 :: 		void IWDG_Enable(void)
;stm32f4xx_iwdg.c,209 :: 		IWDG->KR = KR_KEY_ENABLE;
MOVW	R1, #52428
MOVW	R0, #12288
MOVT	R0, #16384
STR	R1, [R0, #0]
;stm32f4xx_iwdg.c,210 :: 		}
L_end_IWDG_Enable:
BX	LR
; end of _IWDG_Enable
_IWDG_GetFlagStatus:
;stm32f4xx_iwdg.c,236 :: 		FlagStatus IWDG_GetFlagStatus(uint16_t IWDG_FLAG)
; IWDG_FLAG start address is: 0 (R0)
; IWDG_FLAG end address is: 0 (R0)
; IWDG_FLAG start address is: 0 (R0)
;stm32f4xx_iwdg.c,238 :: 		FlagStatus bitstatus = RESET;
;stm32f4xx_iwdg.c,241 :: 		if ((IWDG->SR & IWDG_FLAG) != (uint32_t)RESET)
MOVW	R1, #12300
MOVT	R1, #16384
LDR	R1, [R1, #0]
ANDS	R1, R0
...
;stm32f4xx_iwdg.c,243 :: 		bitstatus = SET;
; bitstatus start address is: 0 (R0)
MOVS	R0, #1
;stm32f4xx_iwdg.c,244 :: 		}
; bitstatus end address is: 0 (R0)
IT	AL
BAL	L_IWDG_GetFlagStatus28
L_IWDG_GetFlagStatus27:
;stm32f4xx_iwdg.c,247 :: 		bitstatus = RESET;
; bitstatus start address is: 0 (R0)
MOVS	R0, #0
; bitstatus end address is: 0 (R0)
;stm32f4xx_iwdg.c,248 :: 		}
L_IWDG_GetFlagStatus28:
;stm32f4xx_iwdg.c,250 :: 		return bitstatus;
; bitstatus start address is: 0 (R0)
; bitstatus end address is: 0 (R0)
;stm32f4xx_iwdg.c,251 :: 		}
