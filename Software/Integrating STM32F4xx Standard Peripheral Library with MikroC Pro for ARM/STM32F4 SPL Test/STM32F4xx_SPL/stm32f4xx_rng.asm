...
L_end___REV:
BX	LR
; end of stm32f4xx_rng___REV
stm32f4xx_rng_NVIC_SetPriorityGrouping:
...
BX	LR
; end of stm32f4xx_rng_NVIC_SetPriorityGrouping
stm32f4xx_rng_NVIC_GetPriorityGrouping:
...
BX	LR
; end of stm32f4xx_rng_NVIC_GetPriorityGrouping
stm32f4xx_rng_NVIC_EnableIRQ:
...
BX	LR
; end of stm32f4xx_rng_NVIC_EnableIRQ
stm32f4xx_rng_NVIC_DisableIRQ:
...
BX	LR
; end of stm32f4xx_rng_NVIC_DisableIRQ
stm32f4xx_rng_NVIC_GetPendingIRQ:
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f4xx_rng_NVIC_GetPendingIRQ0
; ?FLOC__stm32f4xx_rng_NVIC_GetPendingIRQ?T47 start address is: 0 (R0)
MOVS	R0, #1
; ?FLOC__stm32f4xx_rng_NVIC_GetPendingIRQ?T47 end address is: 0 (R0)
IT	AL
BAL	L_stm32f4xx_rng_NVIC_GetPendingIRQ1
L_stm32f4xx_rng_NVIC_GetPendingIRQ0:
; ?FLOC__stm32f4xx_rng_NVIC_GetPendingIRQ?T47 start address is: 0 (R0)
MOV	R0, #0
; ?FLOC__stm32f4xx_rng_NVIC_GetPendingIRQ?T47 end address is: 0 (R0)
L_stm32f4xx_rng_NVIC_GetPendingIRQ1:
; ?FLOC__stm32f4xx_rng_NVIC_GetPendingIRQ?T47 start address is: 0 (R0)
MOV	R0, R0
; ?FLOC__stm32f4xx_rng_NVIC_GetPendingIRQ?T47 end address is: 0 (R0)
;core_cm4.h,1112 :: 		}
...
BX	LR
; end of stm32f4xx_rng_NVIC_GetPendingIRQ
stm32f4xx_rng_NVIC_SetPendingIRQ:
...
BX	LR
; end of stm32f4xx_rng_NVIC_SetPendingIRQ
stm32f4xx_rng_NVIC_ClearPendingIRQ:
...
BX	LR
; end of stm32f4xx_rng_NVIC_ClearPendingIRQ
stm32f4xx_rng_NVIC_GetActive:
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f4xx_rng_NVIC_GetActive2
; ?FLOC__stm32f4xx_rng_NVIC_GetActive?T78 start address is: 0 (R0)
MOVS	R0, #1
; ?FLOC__stm32f4xx_rng_NVIC_GetActive?T78 end address is: 0 (R0)
IT	AL
BAL	L_stm32f4xx_rng_NVIC_GetActive3
L_stm32f4xx_rng_NVIC_GetActive2:
; ?FLOC__stm32f4xx_rng_NVIC_GetActive?T78 start address is: 0 (R0)
MOV	R0, #0
; ?FLOC__stm32f4xx_rng_NVIC_GetActive?T78 end address is: 0 (R0)
L_stm32f4xx_rng_NVIC_GetActive3:
; ?FLOC__stm32f4xx_rng_NVIC_GetActive?T78 start address is: 0 (R0)
MOV	R0, R0
; ?FLOC__stm32f4xx_rng_NVIC_GetActive?T78 end address is: 0 (R0)
;core_cm4.h,1151 :: 		}
...
BX	LR
; end of stm32f4xx_rng_NVIC_GetActive
stm32f4xx_rng_NVIC_SetPriority:
...
CMP	R0, #0
IT	GE
BGE	L_stm32f4xx_rng_NVIC_SetPriority4
...
STRB	R2, [R3, #0]
IT	AL
BAL	L_stm32f4xx_rng_NVIC_SetPriority5
L_stm32f4xx_rng_NVIC_SetPriority4:
...
AND	R2, R2, #255
STRB	R2, [R3, #0]
L_stm32f4xx_rng_NVIC_SetPriority5:
;core_cm4.h,1171 :: 		}
L_end_NVIC_SetPriority:
BX	LR
; end of stm32f4xx_rng_NVIC_SetPriority
stm32f4xx_rng_NVIC_GetPriority:
...
CMP	R0, #0
IT	GE
BGE	L_stm32f4xx_rng_NVIC_GetPriority6
...
L_stm32f4xx_rng_NVIC_GetPriority6:
...
BX	LR
; end of stm32f4xx_rng_NVIC_GetPriority
stm32f4xx_rng_NVIC_EncodePriority:
...
CMP	R3, #4
IT	LS
BLS	L_stm32f4xx_rng_NVIC_EncodePriority8
; ?FLOC__stm32f4xx_rng_NVIC_EncodePriority?T118 start address is: 12 (R3)
MOV	R3, #4
; ?FLOC__stm32f4xx_rng_NVIC_EncodePriority?T118 end address is: 12 (R3)
IT	AL
BAL	L_stm32f4xx_rng_NVIC_EncodePriority9
L_stm32f4xx_rng_NVIC_EncodePriority8:
RSB	R3, R4, #7
; ?FLOC__stm32f4xx_rng_NVIC_EncodePriority?T118 start address is: 0 (R0)
MOV	R0, R3
; ?FLOC__stm32f4xx_rng_NVIC_EncodePriority?T118 end address is: 0 (R0)
MOV	R3, R0
L_stm32f4xx_rng_NVIC_EncodePriority9:
; ?FLOC__stm32f4xx_rng_NVIC_EncodePriority?T118 start address is: 12 (R3)
...
CMP	R3, #7
IT	CS
BCS	L_stm32f4xx_rng_NVIC_EncodePriority10
; PriorityGroupTmp end address is: 16 (R4)
; ?FLOC__stm32f4xx_rng_NVIC_EncodePriority?T122 start address is: 20 (R5)
MOV	R5, #0
; ?FLOC__stm32f4xx_rng_NVIC_EncodePriority?T122 end address is: 20 (R5)
IT	AL
BAL	L_stm32f4xx_rng_NVIC_EncodePriority11
L_stm32f4xx_rng_NVIC_EncodePriority10:
; PriorityGroupTmp start address is: 16 (R4)
SUBS	R5, R4, #7
; PriorityGroupTmp end address is: 16 (R4)
ADDS	R5, R5, #4
; ?FLOC__stm32f4xx_rng_NVIC_EncodePriority?T122 start address is: 20 (R5)
; ?FLOC__stm32f4xx_rng_NVIC_EncodePriority?T122 end address is: 20 (R5)
L_stm32f4xx_rng_NVIC_EncodePriority11:
...
BX	LR
; end of stm32f4xx_rng_NVIC_EncodePriority
stm32f4xx_rng_NVIC_DecodePriority:
...
CMP	R4, #4
IT	LS
BLS	L_stm32f4xx_rng_NVIC_DecodePriority12
; ?FLOC__stm32f4xx_rng_NVIC_DecodePriority?T136 start address is: 16 (R4)
MOV	R4, #4
; ?FLOC__stm32f4xx_rng_NVIC_DecodePriority?T136 end address is: 16 (R4)
IT	AL
BAL	L_stm32f4xx_rng_NVIC_DecodePriority13
L_stm32f4xx_rng_NVIC_DecodePriority12:
RSB	R4, R5, #7
; ?FLOC__stm32f4xx_rng_NVIC_DecodePriority?T136 start address is: 4 (R1)
MOV	R1, R4
; ?FLOC__stm32f4xx_rng_NVIC_DecodePriority?T136 end address is: 4 (R1)
MOV	R4, R1
L_stm32f4xx_rng_NVIC_DecodePriority13:
; ?FLOC__stm32f4xx_rng_NVIC_DecodePriority?T136 start address is: 16 (R4)
...
CMP	R4, #7
IT	CS
BCS	L_stm32f4xx_rng_NVIC_DecodePriority14
; PriorityGroupTmp end address is: 20 (R5)
; ?FLOC__stm32f4xx_rng_NVIC_DecodePriority?T140 start address is: 16 (R4)
MOV	R4, #0
; ?FLOC__stm32f4xx_rng_NVIC_DecodePriority?T140 end address is: 16 (R4)
IT	AL
BAL	L_stm32f4xx_rng_NVIC_DecodePriority15
L_stm32f4xx_rng_NVIC_DecodePriority14:
; PriorityGroupTmp start address is: 20 (R5)
SUBS	R4, R5, #7
; PriorityGroupTmp end address is: 20 (R5)
ADDS	R4, R4, #4
; ?FLOC__stm32f4xx_rng_NVIC_DecodePriority?T140 start address is: 20 (R5)
MOV	R5, R4
; ?FLOC__stm32f4xx_rng_NVIC_DecodePriority?T140 end address is: 20 (R5)
MOV	R4, R5
L_stm32f4xx_rng_NVIC_DecodePriority15:
; ?FLOC__stm32f4xx_rng_NVIC_DecodePriority?T140 start address is: 16 (R4)
...
L_stm32f4xx_rng_NVIC_SystemReset16:
IT	AL
BAL	L_stm32f4xx_rng_NVIC_SystemReset16
;core_cm4.h,1267 :: 		}
L_end_NVIC_SystemReset:
LDR	LR, [SP, #0]
ADD	SP, SP, #4
BX	LR
; end of stm32f4xx_rng_NVIC_SystemReset
stm32f4xx_rng_SysTick_Config:
...
CMP	R0, R1
IT	LS
BLS	L_stm32f4xx_rng_SysTick_Config18
; ticks end address is: 0 (R0)
MOVS	R0, #1
IT	AL
BAL	L_end_SysTick_Config
L_stm32f4xx_rng_SysTick_Config18:
...
MOVS	R0, #-1
SXTB	R0, R0
BL	stm32f4xx_rng_NVIC_SetPriority+0
...
ADD	SP, SP, #4
BX	LR
; end of stm32f4xx_rng_SysTick_Config
stm32f4xx_rng_ITM_SendChar:
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f4xx_rng_ITM_SendChar39
MOVW	R1, #3712
MOVT	R1, #57344
LDR	R1, [R1, #0]
AND	R1, R1, #1
CMP	R1, #0
IT	EQ
BEQ	L_stm32f4xx_rng_ITM_SendChar40
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f4xx_rng_ITM_SendChar41
L_stm32f4xx_rng_ITM_SendChar35:
;core_cm4.h,1334 :: 		while (ITM->PORT[0].u32 == 0);
L_stm32f4xx_rng_ITM_SendChar22:
; ch end address is: 0 (R0)
; ch start address is: 0 (R0)
MOVW	R1, #0
MOVT	R1, #57344
...
CMP	R1, #0
IT	NE
BNE	L_stm32f4xx_rng_ITM_SendChar23
IT	AL
BAL	L_stm32f4xx_rng_ITM_SendChar22
L_stm32f4xx_rng_ITM_SendChar23:
...
;core_cm4.h,1331 :: 		(ITM->TCR & ITM_TCR_ITMENA_Msk)                  &&      /* ITM enabled */
IT	AL
BAL	L_stm32f4xx_rng_ITM_SendChar38
L_stm32f4xx_rng_ITM_SendChar39:
L_stm32f4xx_rng_ITM_SendChar38:
; ch start address is: 0 (R0)
; ch end address is: 0 (R0)
IT	AL
BAL	L_stm32f4xx_rng_ITM_SendChar37
L_stm32f4xx_rng_ITM_SendChar40:
L_stm32f4xx_rng_ITM_SendChar37:
;core_cm4.h,1332 :: 		(ITM->TER & (1UL << 0)        )                    )     /* ITM Port #0 enabled */
; ch start address is: 0 (R0)
; ch end address is: 0 (R0)
IT	AL
BAL	L_stm32f4xx_rng_ITM_SendChar36
L_stm32f4xx_rng_ITM_SendChar41:
L_stm32f4xx_rng_ITM_SendChar36:
...
L_end_ITM_SendChar:
BX	LR
; end of stm32f4xx_rng_ITM_SendChar
stm32f4xx_rng_ITM_ReceiveChar:
...
CMP	R1, R0
IT	EQ
BEQ	L_stm32f4xx_rng_ITM_ReceiveChar24
...
STR	R1, [R0, #0]
;core_cm4.h,1356 :: 		}
L_stm32f4xx_rng_ITM_ReceiveChar24:
...
ADD	SP, SP, #4
BX	LR
; end of stm32f4xx_rng_ITM_ReceiveChar
stm32f4xx_rng_ITM_CheckChar:
...
CMP	R1, R0
IT	NE
BNE	L_stm32f4xx_rng_ITM_CheckChar25
;core_cm4.h,1373 :: 		return (0);                                 /* no character available */
MOV	R0, #0
IT	AL
BAL	L_end_ITM_CheckChar
;core_cm4.h,1374 :: 		} else {
L_stm32f4xx_rng_ITM_CheckChar25:
;core_cm4.h,1375 :: 		return (1);                                 /*    character available */
MOVS	R0, #1
;core_cm4.h,1377 :: 		}
L_end_ITM_CheckChar:
BX	LR
; end of stm32f4xx_rng_ITM_CheckChar
_RNG_DeInit:
;stm32f4xx_rng.c,100 :: 		void RNG_DeInit(void)
SUB	SP, SP, #4
STR	LR, [SP, #0]
;stm32f4xx_rng.c,103 :: 		RCC_AHB2PeriphResetCmd(RCC_AHB2Periph_RNG, ENABLE);
MOVS	R1, #1
MOV	R0, #64
BL	_RCC_AHB2PeriphResetCmd+0
;stm32f4xx_rng.c,106 :: 		RCC_AHB2PeriphResetCmd(RCC_AHB2Periph_RNG, DISABLE);
MOVS	R1, #0
MOV	R0, #64
BL	_RCC_AHB2PeriphResetCmd+0
;stm32f4xx_rng.c,107 :: 		}
...
; end of _RNG_DeInit
_RNG_Cmd:
;stm32f4xx_rng.c,115 :: 		void RNG_Cmd(FunctionalState NewState)
; NewState start address is: 0 (R0)
; NewState end address is: 0 (R0)
; NewState start address is: 0 (R0)
;stm32f4xx_rng.c,120 :: 		if (NewState != DISABLE)
CMP	R0, #0
IT	EQ
BEQ	L_RNG_Cmd27
; NewState end address is: 0 (R0)
;stm32f4xx_rng.c,123 :: 		RNG->CR |= RNG_CR_RNGEN;
MOVW	R2, #2048
MOVT	R2, #20486
LDR	R1, [R2, #0]
ORR	R1, R1, #4
...
BAL	L_RNG_Cmd28
L_RNG_Cmd27:
;stm32f4xx_rng.c,128 :: 		RNG->CR &= ~RNG_CR_RNGEN;
MOVW	R3, #2048
MOVT	R3, #20486
LDR	R2, [R3, #0]
MVN	R1, #4
...
BX	LR
; end of _RNG_Cmd
_RNG_GetRandomNumber:
;stm32f4xx_rng.c,177 :: 		uint32_t RNG_GetRandomNumber(void)
;stm32f4xx_rng.c,180 :: 		return RNG->DR;
MOVW	R0, #2056
MOVT	R0, #20486
LDR	R0, [R0, #0]
;stm32f4xx_rng.c,181 :: 		}
L_end_RNG_GetRandomNumber:
BX	LR
; end of _RNG_GetRandomNumber
_RNG_ITConfig:
;stm32f4xx_rng.c,274 :: 		void RNG_ITConfig(FunctionalState NewState)
; NewState start address is: 0 (R0)
; NewState end address is: 0 (R0)
; NewState start address is: 0 (R0)
;stm32f4xx_rng.c,279 :: 		if (NewState != DISABLE)
CMP	R0, #0
IT	EQ
BEQ	L_RNG_ITConfig29
; NewState end address is: 0 (R0)
;stm32f4xx_rng.c,282 :: 		RNG->CR |= RNG_CR_IE;
MOVW	R2, #2048
MOVT	R2, #20486
LDR	R1, [R2, #0]
ORR	R1, R1, #8
...
;stm32f4xx_rng.c,283 :: 		}
IT	AL
BAL	L_RNG_ITConfig30
L_RNG_ITConfig29:
;stm32f4xx_rng.c,287 :: 		RNG->CR &= ~RNG_CR_IE;
MOVW	R3, #2048
MOVT	R3, #20486
LDR	R2, [R3, #0]
MVN	R1, #8
...
L_end_RNG_ITConfig:
BX	LR
; end of _RNG_ITConfig
_RNG_GetFlagStatus:
;stm32f4xx_rng.c,300 :: 		FlagStatus RNG_GetFlagStatus(uint8_t RNG_FLAG)
; RNG_FLAG start address is: 0 (R0)
; RNG_FLAG end address is: 0 (R0)
; RNG_FLAG start address is: 0 (R0)
;stm32f4xx_rng.c,302 :: 		FlagStatus bitstatus = RESET;
;stm32f4xx_rng.c,307 :: 		if ((RNG->SR & RNG_FLAG) != (uint8_t)RESET)
MOVW	R1, #2052
MOVT	R1, #20486
LDR	R1, [R1, #0]
ANDS	R1, R0
...
CMP	R1, #0
IT	EQ
BEQ	L_RNG_GetFlagStatus31
;stm32f4xx_rng.c,310 :: 		bitstatus = SET;
; bitstatus start address is: 0 (R0)
MOVS	R0, #1
;stm32f4xx_rng.c,311 :: 		}
; bitstatus end address is: 0 (R0)
IT	AL
BAL	L_RNG_GetFlagStatus32
L_RNG_GetFlagStatus31:
;stm32f4xx_rng.c,315 :: 		bitstatus = RESET;
; bitstatus start address is: 0 (R0)
MOVS	R0, #0
; bitstatus end address is: 0 (R0)
;stm32f4xx_rng.c,316 :: 		}
L_RNG_GetFlagStatus32:
;stm32f4xx_rng.c,318 :: 		return  bitstatus;
; bitstatus start address is: 0 (R0)
; bitstatus end address is: 0 (R0)
;stm32f4xx_rng.c,319 :: 		}
L_end_RNG_GetFlagStatus:
BX	LR
; end of _RNG_GetFlagStatus
_RNG_ClearFlag:
;stm32f4xx_rng.c,333 :: 		void RNG_ClearFlag(uint8_t RNG_FLAG)
; RNG_FLAG start address is: 0 (R0)
; RNG_FLAG end address is: 0 (R0)
; RNG_FLAG start address is: 0 (R0)
;stm32f4xx_rng.c,338 :: 		RNG->SR = ~(uint32_t)(((uint32_t)RNG_FLAG) << 4);
UXTB	R1, R0
; RNG_FLAG end address is: 0 (R0)
LSLS	R1, R1, #4
MVN	R2, R1
...
L_end_RNG_ClearFlag:
BX	LR
; end of _RNG_ClearFlag
_RNG_GetITStatus:
;stm32f4xx_rng.c,349 :: 		ITStatus RNG_GetITStatus(uint8_t RNG_IT)
; RNG_IT start address is: 0 (R0)
; RNG_IT end address is: 0 (R0)
; RNG_IT start address is: 0 (R0)
;stm32f4xx_rng.c,351 :: 		ITStatus bitstatus = RESET;
;stm32f4xx_rng.c,356 :: 		if ((RNG->SR & RNG_IT) != (uint8_t)RESET)
MOVW	R1, #2052
MOVT	R1, #20486
LDR	R1, [R1, #0]
ANDS	R1, R0
...
CMP	R1, #0
IT	EQ
BEQ	L_RNG_GetITStatus33
;stm32f4xx_rng.c,359 :: 		bitstatus = SET;
; bitstatus start address is: 0 (R0)
MOVS	R0, #1
;stm32f4xx_rng.c,360 :: 		}
; bitstatus end address is: 0 (R0)
IT	AL
BAL	L_RNG_GetITStatus34
L_RNG_GetITStatus33:
;stm32f4xx_rng.c,364 :: 		bitstatus = RESET;
; bitstatus start address is: 0 (R0)
MOVS	R0, #0
; bitstatus end address is: 0 (R0)
;stm32f4xx_rng.c,365 :: 		}
L_RNG_GetITStatus34:
;stm32f4xx_rng.c,367 :: 		return bitstatus;
; bitstatus start address is: 0 (R0)
; bitstatus end address is: 0 (R0)
;stm32f4xx_rng.c,368 :: 		}
L_end_RNG_GetITStatus:
BX	LR
; end of _RNG_GetITStatus
_RNG_ClearITPendingBit:
;stm32f4xx_rng.c,379 :: 		void RNG_ClearITPendingBit(uint8_t RNG_IT)
; RNG_IT start address is: 0 (R0)
; RNG_IT end address is: 0 (R0)
; RNG_IT start address is: 0 (R0)
;stm32f4xx_rng.c,385 :: 		RNG->SR = (uint8_t)~RNG_IT;
MVN	R2, R0
UXTB	R2, R2
; RNG_IT end address is: 0 (R0)
MOVW	R1, #2052
...
STR	R2, [R1, #0]
;stm32f4xx_rng.c,386 :: 		}
L_end_RNG_ClearITPendingBit:
BX	LR
; end of _RNG_ClearITPendingBit
