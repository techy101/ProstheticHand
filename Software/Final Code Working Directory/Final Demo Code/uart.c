...
void init_UART() {
    ...
    // Initialize Wireless Bluetooth UART
    UART2_Init_Advanced(UART_BAUD_RATE, _UART_8_BIT_DATA, _UART_NOPARITY, _UART_ONE_STOPBIT, &_GPIO_MODULE_USART2_PD56);
