...
extern const int setP;                                   // Setpoint - desired position. normalized for 0-1000 range. CHANGE TO 3000 AND TEST CONTROL FOR DEMO.
extern const int MARGIN;                                   // Accuracy of PV - 1.5% from normalization constant
extern const float const K;                            // Proportion constant for P control
