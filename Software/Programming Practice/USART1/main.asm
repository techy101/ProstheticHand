...
SUB	SP, SP, #4
STR	LR, [SP, #0]
;main.c,6 :: 		if(UART1_Data_ready()) {
BL	_UART1_Data_Ready+0
CMP	R0, #0
IT	EQ
BEQ	L_USART1_INT0
;main.c,7 :: 		uart1_rd = UART1_Read();
BL	_UART1_Read+0
MOVW	R1, #lo_addr(_uart1_rd+0)
MOVT	R1, #hi_addr(_uart1_rd+0)
STRB	R0, [R1, #0]
;main.c,8 :: 		UART1_Write(uart1_rd);
UXTB	R0, R0
BL	_UART1_Write+0
;main.c,9 :: 		}
L_USART1_INT0:
...
_main:
;main.c,22 :: 		void main() {
;main.c,24 :: 		UART1_Init(115200);              // Initialize UART module at 115200 bps
MOV	R0, #115200
BL	_UART1_Init+0
;main.c,25 :: 		Delay_ms(100);                  // Wait for UART module to stabilize
MOVW	R7, #29438
MOVT	R7, #85
NOP
NOP
...
NOP
NOP
;main.c,27 :: 		UART1_Write_Text("Start FTDI Wired");
MOVW	R0, #lo_addr(?lstr1_main+0)
MOVT	R0, #hi_addr(?lstr1_main+0)
BL	_UART1_Write_Text+0
;main.c,28 :: 		UART1_Write(13);
MOVS	R0, #13
BL	_UART1_Write+0
;main.c,29 :: 		UART1_Write(10);
MOVS	R0, #10
BL	_UART1_Write+0
;main.c,33 :: 		UART2_Init_Advanced(115200, _UART_8_BIT_DATA, _UART_NOPARITY, _UART_ONE_STOPBIT, &_GPIO_MODULE_USART2_PD56);
...
ADD	SP, SP, #4
;main.c,34 :: 		Delay_ms(100);                  // Wait for UART module to stabilize
MOVW	R7, #29438
MOVT	R7, #85
NOP
NOP
...
NOP
NOP
;main.c,36 :: 		UART2_Write_Text("Start Bluetooth");
MOVW	R0, #lo_addr(?lstr2_main+0)
MOVT	R0, #hi_addr(?lstr2_main+0)
BL	_UART2_Write_Text+0
;main.c,37 :: 		UART2_Write(13);
MOVS	R0, #13
BL	_UART2_Write+0
;main.c,38 :: 		UART2_Write(10);
MOVS	R0, #10
BL	_UART2_Write+0
;main.c,39 :: 		NVIC_IntEnable(IVT_INT_USART1);
MOVW	R0, #53
BL	_NVIC_IntEnable+0
;main.c,40 :: 		NVIC_IntEnable(IVT_INT_USART2);
MOVW	R0, #54
BL	_NVIC_IntEnable+0
;main.c,41 :: 		SYSCFGEN_bit = 1;
MOVS	R2, #1
SXTB	R2, R2
MOVW	R0, #lo_addr(SYSCFGEN_bit+0)
MOVT	R0, #hi_addr(SYSCFGEN_bit+0)
STR	R2, [R0, #0]
;main.c,42 :: 		SYSCFG_EXTICR1=0b0010001000000000;
MOVW	R1, #8704
MOVW	R0, #lo_addr(SYSCFG_EXTICR1+0)
MOVT	R0, #hi_addr(SYSCFG_EXTICR1+0)
STR	R1, [R0, #0]
;main.c,43 :: 		EXTI_IMR = EXTI_IMR | 0b1100;
...
MOVT	R0, #hi_addr(EXTI_IMR+0)
STR	R1, [R0, #0]
;main.c,44 :: 		EXTI_RTSR =  0b0;
MOVS	R1, #0
MOVW	R0, #lo_addr(EXTI_RTSR+0)
MOVT	R0, #hi_addr(EXTI_RTSR+0)
STR	R1, [R0, #0]
;main.c,45 :: 		EXTI_FTSR = EXTI_RTSR | 0b1100;
MOVW	R0, #lo_addr(EXTI_RTSR+0)
MOVT	R0, #hi_addr(EXTI_RTSR+0)
LDR	R0, [R0, #0]
ORR	R1, R0, #12
