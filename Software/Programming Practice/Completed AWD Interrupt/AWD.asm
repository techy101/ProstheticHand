...
_motor_1_pwm_sweep:
;AWD.c,156 :: 		void motor_1_pwm_sweep() {
SUB	SP, SP, #4
STR	LR, [SP, #0]
;AWD.c,157 :: 		if(motorState){
...
;AWD.c,158 :: 		PWM_TIM1_Set_Duty(10000, _PWM_NON_INVERTED, _PWM_CHANNEL1);  // Setting duty cycle to 10000
MOVS	R2, #0
MOVS	R1, #0
MOVW	R0, #10000
BL	_PWM_TIM1_Set_Duty+0
;AWD.c,159 :: 		motorState = 0;
MOVS	R1, #0
SXTH	R1, R1
MOVW	R0, #lo_addr(_motorState+0)
MOVT	R0, #hi_addr(_motorState+0)
...
;AWD.c,161 :: 		PWM_TIM1_Set_Duty(0, _PWM_NON_INVERTED, _PWM_CHANNEL1);      // Setting duty cycle to 0
MOVS	R2, #0
MOVS	R1, #0
MOVS	R0, #0
BL	_PWM_TIM1_Set_Duty+0
;AWD.c,162 :: 		motorState = 1;
MOVS	R1, #1
SXTH	R1, R1
MOVW	R0, #lo_addr(_motorState+0)
MOVT	R0, #hi_addr(_motorState+0)
