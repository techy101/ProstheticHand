 ...
 * To do:
     Figure out how to access different lines in interrupt vectors that share addresses
     (EXTI15_10 and EXTI9_5)

 * Pin Configuration
     PE0: All Motor Driver IC's Enable
     PE1: Motor 1 Direction Output
